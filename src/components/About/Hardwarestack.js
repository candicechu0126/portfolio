  ...
  return (
    <div className="scroller">
      ...
      <Col xs={4} md={2} className="tech-icons">
        ...
        <img src={rasperrypi} alt="rasperrypi" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">ESP8266</div>
        <img src={esp8266} alt="esp8266" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">MQ-135 Air Quality Sensor</div>
        <img src={mq135} alt="mq135" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">L298N Motor Driver</div>
        <img src={l298n} alt="l298n" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">HC-SR04 Ultrasonic Sensor</div>
        <img src={hcsr04} alt="hcsr04" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">LM35 Temperature Sensor</div>
        <img src={lm35} alt="lm35" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">Digital Tilt Sensor</div>
        <img src={tilt} alt="tilt sensor" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">DHT11 Sensor</div>
        <img src={dht11} alt="dht11" width="150px" height="130px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">HC-05 Bluetooth</div>
        <img src={hc05} alt="hc05" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">3-Axis Digital Compass IC HMC5883L</div>
        <img src={axis3} alt="axis3" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">DC Motor and Fan</div>
        <img src={dcmotor} alt="dcmotor" width="150px" height="100px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">Infrared Sensors</div>
        <img src={ir} alt="ir" width="100px" height="150px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <div className="text">Pyro-electric Infrared Detector</div>
        <img src={pir} alt="pir" width="140px" height="120px" />
      </Col>
      <Col xs={4} md={2} className="tech-icons">
      ...
      <Col xs={4} md={2} className="tech-icons">
        ...
        <img src={servomotor} alt="servomotor" width="140px" height="130px" />
      </Col>
    </div>
  );
}
